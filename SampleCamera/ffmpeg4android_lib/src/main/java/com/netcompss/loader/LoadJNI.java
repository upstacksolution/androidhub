		...
		if(file.exists())  {     
		  Log.i(Prefs.TAG, "videokitLibPath exits");
			...
			if(file.exists())  {
				...
				Log.w(Prefs.TAG, "videokitLibPath not exits: " + videokitLibPath);
				videokitLibPath = "/data/app/com.upstack.materialcamerasample_demo-1/lib/arm64/libvideokit.so";
				Log.i(Prefs.TAG, "trying videokitLibPath: " + videokitLibPath);
				file = new File(videokitLibPath);
				if(file.exists())  {
					Log.i(Prefs.TAG, "videokitLibPath exits: " + videokitLibPath);
					...
					Log.w(Prefs.TAG, "videokitLibPath not exits: " + videokitLibPath);
					videokitLibPath = "/data/app/com.upstack.materialcamerasample_demo-2/lib/arm64/libvideokit.so";
					Log.i(Prefs.TAG, "trying videokitLibPath: " + videokitLibPath);
					if(file.exists())  {
						Log.i(Prefs.TAG, "videokitLibPath exits: " + videokitLibPath);
					}
